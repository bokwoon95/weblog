...
var t1 = template.Must(template.New("t1").Funcs(t1_funcs).Option("missingkey=error").Parse(t1_text))
...
var t2 = template.Must(template.New("t2").Funcs(t2_funcs).Option("missingkey=error").Parse(t2_text))
